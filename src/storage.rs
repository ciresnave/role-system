    ...
    impl FileStorage {
        ...
        fn load_from_disk(&mut self) -> Result<()> {
            ...
            let file = File::open(&self.storage_path).map_err(|e| {
                Error::Storage(format!("Failed to open storage file: {}", e))
            })?;
        ...
        fn save_to_disk(&self) -> Result<()> {
            let file = OpenOptions::new()
                ...
                .map_err(|e| {
                    Error::Storage(format!("Failed to create storage file: {}", e))
                })?;
...
mod tests {
    ...
    fn test_file_storage() {
        ...
        
        {
            ...
            let role = Role::new("file-test-role")
                .add_permission(Permission::new("read", "documents"));
    ...
    fn test_composite_storage() {
        ...
        let role = Role::new("composite-test")
            .add_permission(Permission::new("read", "documents"));
